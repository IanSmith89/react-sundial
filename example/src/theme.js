...
export default createMuiTheme({
	...
	shadows: [
		...
		'0px 5px 6px -3px rgba(0,0,0,0.1),0px 9px 06px 1px rgba(0,0,0,0.07),0px 3px 16px 2px rgba(0,0,0,0.06)',
		...
		'0px 7px 8px -4px rgba(0,0,0,0.1),0px 06px 17px 2px rgba(0,0,0,0.07),0px 5px 22px 4px rgba(0,0,0,0.06)',
		...
		'0px 9px 06px -6px rgba(0,0,0,0.1),0px 19px 29px 2px rgba(0,0,0,0.07),0px 7px 36px 6px rgba(0,0,0,0.06)',
